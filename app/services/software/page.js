  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-16">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold dark:text-white">Software & API</h1>
      ...
      <section className="grid md:grid-cols-3 gap-6 mb-12 ">
        <article className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transform transition hover:-translate-y-1 dark:bg-[#070129]">
          <h3 className="font-semibold dark:text-white">Public & private APIs</h3>
          <p className="text-gray-600 mt-2">Design, versioning and developer experience for reliable integrations.</p>
        </article>

        <article className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transform transition hover:-translate-y-1 dark:bg-[#070129]">
          <h3 className="font-semibold dark:text-white">Automation & tools</h3>
          <p className="text-gray-600 mt-2">Internal dashboards, job automation and observability.</p>
        </article>

        <article className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transform transition hover:-translate-y-1 dark:bg-[#070129]">
          <h3 className="font-semibold dark:text-white">CI/CD & infra</h3>
